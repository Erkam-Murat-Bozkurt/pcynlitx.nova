...
Header_File_Determiner.exe: Source_File_Determiner_Main_File.cpp Source_File_Determiner.cpp \
	StringOperator.cpp CharOperator.cpp Cpp_FileOperations.cpp Source_File_Determiner.h \
	StringOperator.h CharOperator.h Cpp_FileOperations.h

	g++ -std=c++17 -o Source_File_Determiner.exe \
	  -I$(STRING_OPS) -I$(CHAR_OPS) -I$(FILE_OPRS) \
	  -L$(STRING_OPS) -L$(CHAR_OPS) -L$(FILE_OPRS) \
		Source_File_Determiner_Main_File.cpp Source_File_Determiner.cpp \
