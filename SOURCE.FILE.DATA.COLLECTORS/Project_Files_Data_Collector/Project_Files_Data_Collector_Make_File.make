...
Project_Files_Data_Collector.exe: Project_Files_Data_Collector_Main_File.cpp \
	...
	DirectoryOperations.cpp CharOperator.cpp Cpp_FileOperations.cpp \
	...
	g++ -std=c++17 -o Project_Files_Data_Collector.exe \
		-I$(GIT_LIST) -I$(DIR_OPS) -I$(FILE_OPRS) -I$(DES_READ) -I$(DES_DATA_COL) -I$(STR_OPR) -I$(CHAR_OPR) \
		-L-I$(GIT_LIST) -L$(DIR_OPS) -L$(FILE_OPRS) -L$(DES_READ) -L$(DES_DATA_COL) -L$(STR_OPR) -L$(CHAR_OPR) \
	 	Project_Files_Data_Collector_Main_File.cpp Project_Files_Data_Collector.cpp \
		$(GIT_LIST)\Git_File_List_Receiver.cpp \
	 	$(DES_READ)\Descriptor_File_Reader.cpp \
	 	$(DES_DATA_COL)\Descriptor_File_Data_Collector.cpp $(STR_OPR)\StringOperator.cpp\
	 	$(DIR_OPS)\DirectoryOperations.cpp $(CHAR_OPR)\CharOperator.cpp \
	 	$(FILE_OPRS)\Cpp_FileOperations.cpp -include Project_Files_Data_Collector.hpp \
	 	-include $(GIT_LIST)\Git_File_List_Receiver.hpp -include $(DES_READ)\Descriptor_File_Reader.hpp \
	 	-include $(STR_OPR)\StringOperator.h -include $(DES_DATA_COL)\Descriptor_File_Data_Collector.hpp \
	 	-include $(DIR_OPS)\DirectoryOperations.h -include $(CHAR_OPR)\CharOperator.h \
