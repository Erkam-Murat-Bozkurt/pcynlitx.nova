...
SRC_DEP_DETER=D:\pcynlitx.build\SOURCE.FILE.PROCESSING.SYSTEM\Source_File_Dependency_Determiner
...
MakeFile_Directory_Constructor.exe: MakeFile_Directory_Constructor_Main_File.cpp \
    MakeFile_Directory_Constructor.cpp \
	...
	MakeFile_Directory_Constructor.hpp \
	...
	g++ -std=c++17 -static-libgcc -static-libstdc++ -ggdb \
		-o MakeFile_Directory_Constructor.exe \
	 	-I$(DIR_OPS) \
		-I$(CPP_OPS) \
		-I$(CHAR_OPS) \
	 	-I$(SRC_INF_CL) \
		...
		-include $(MK_DIR_CON)\MakeFile_Directory_Constructor.hpp \
		-include $(SRC_DEP_DETER)\Source_File_Dependency_Determiner.hpp \
