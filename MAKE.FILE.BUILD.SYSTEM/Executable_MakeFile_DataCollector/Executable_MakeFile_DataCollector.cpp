...
Executable_MakeFile_DataCollector::Executable_MakeFile_DataCollector(const

     Executable_MakeFile_DataCollector & orig){
...
void Executable_MakeFile_DataCollector::Clear_Dynamic_Memory(){
...
void Executable_MakeFile_DataCollector::Receive_Descriptor_File_Reader(Descriptor_File_Reader * Des_Reader){
...
void Executable_MakeFile_DataCollector::Receive_Source_File_Info(Project_Files_Lister * Pointer){
...
void Executable_MakeFile_DataCollector::Determine_Header_File_List(){
...
void Executable_MakeFile_DataCollector::Determine_Header_Repo_Warehouse_Path(char ** wrd_path,
...
void Executable_MakeFile_DataCollector::Extract_Header_File_Name_From_Decleration(char ** header_name,
...
void Executable_MakeFile_DataCollector::Delete_Spaces_on_String(char ** pointer){
...
void Executable_MakeFile_DataCollector::Construct_Temporary_String(char ** tmp_string,
...
void Executable_MakeFile_DataCollector::Determine_Warehouse_Header_Dir(char operating_sis){
...
void Executable_MakeFile_DataCollector::Determine_Warehouse_Object_Dir(char operating_sis){
...
void Executable_MakeFile_DataCollector::Clear_Pointer_Memory(char ** Pointer){
 ...
 void Executable_MakeFile_DataCollector::Convert_to_CString(char ** pointer, std::string path){
  ...
  void Executable_MakeFile_DataCollector::Print_Header_Data(){
  ...
  void Executable_MakeFile_DataCollector::Initialize_Header_Data(){
  ...
  void Executable_MakeFile_DataCollector::Extract_Obj_File_Name_From_Header_Name(char ** object_name,
  ...
  bool Executable_MakeFile_DataCollector::is_this_independent_header(std::string header_name){
  ...
  void Executable_MakeFile_DataCollector::Extract_Header_File_Name_From_Path(char * path,
  ...
  void Executable_MakeFile_DataCollector::Add_String(char ** list, char * string, int * index){
  ...
  void Executable_MakeFile_DataCollector::Place_String(std::string * str_pointer, char * string){
  ...
  void Executable_MakeFile_DataCollector::Place_CString(char ** str_pointer, std::string string){
  ...
  void Executable_MakeFile_DataCollector::Place_CString(char ** str_pointer, char * string){
  ...
  Compiler_Data_CString * Executable_MakeFile_DataCollector::Get_Compiler_Data(){
