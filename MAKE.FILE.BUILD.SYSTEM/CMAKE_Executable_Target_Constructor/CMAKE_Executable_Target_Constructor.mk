...
CMAKE_Executable_Target_Constructor.exe: CMAKE_Executable_Target_Constructor_Main_File.cpp \
	...
	g++ -std=c++17 -g -o CMAKE_Executable_Target_Constructor.exe \
	 ...
	 -L$(SRC_DEP_SL_SF) \
	 -L$(MAKE_FILE_PATH) \
		CMAKE_Executable_Target_Constructor_Main_File.cpp \
		CMAKE_Executable_Target_Constructor.cpp \
