...
void Print_Descriptor_File_Informations(GUI_Descriptor_File_Reader & Des_File_Reader);
...
int main(int argc, char ** argv){
    ...
    GUI_Descriptor_File_Reader Des_File_Reader('w');    

    Des_File_Reader.Receive_Descriptor_File_Path(argv[1]);

    Des_File_Reader.Read_Descriptor_File();

    std::cout << "\n Read success status:" << Des_File_Reader.Get_Gui_Read_Success_Status();

    std::cout << "\n Read syntax error status:" << Des_File_Reader.Get_Syntax_Error_Status();

    std::cout << "\n Read gui read:" << Des_File_Reader.Get_Gui_Read_Status();
