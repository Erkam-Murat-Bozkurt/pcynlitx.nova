...
public:
 ...
 std::string Get_Library_Directory(int i) const ;
 std::string Get_Library_File(int i) const ;
 std::string Get_Source_File_Directory(int i) const ;
 std::string Get_Include_Directory(int i) const;
 void Extract_Library_Names_From_Path();
 const std::vector<std::string> & Get_Include_Directories() const;
 const std::vector<std::string> & Get_Library_Directories() const;
 const std::vector<std::string> & Get_Source_File_Directories() const;
 const std::vector<std::string> & Get_Library_Files() const;
 const std::vector<std::string> & Get_Exe_File_Names() const;  
 const std::vector<std::string> & Get_Compiler_Options() const;
 const std::vector<std::string> & Get_Linker_Options() const;
 const std::vector<std::string> & Get_Compiler_Paths() const;
 const std::vector<Library_Data> & Get_Library_File_Data_List() const;
 std::string Get_Standard() const;
 std::string Get_Build_System_Type() const;
 std::string Get_Warehouse_Location() const;
 std::string Get_Repo_Directory_Location() const;
 std::string Get_Descriptor_File_Path() const;
 std::string Get_Error_Message() const;
 std::string Get_Project_Name() const;
 std::string Get_Version_Number() const;
 int Get_Library_Directory_Number() const;
 int Get_Library_Files_Number() const;
 int Get_Source_File_Directory_Number() const;
 int Get_Include_Directory_Number() const;
 bool Get_Invalid_Descriptor_File_Status() const;
 bool Get_Syntax_Error_Status() const;
protected:
