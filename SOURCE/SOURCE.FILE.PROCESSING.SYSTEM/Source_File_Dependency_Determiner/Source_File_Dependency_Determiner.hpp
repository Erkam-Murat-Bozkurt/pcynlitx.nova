...
public:
 ...
 int  Get_Compiler_Data_Size() const;
 bool Get_Simple_Search_Status() const ;
 ...
 Compiler_Data Get_Compiler_Data(int i) const;
 const std::vector<Compiler_Data> *  Get_Compiler_Data_Address() const ;
 const Simple_Source_File_Dependency * Get_Simple_File_Dependencies() const;
protected:
