...
BEGIN_EVENT_TABLE(MainFrame,wxFrame)
  ...
  EVT_MENU(ID_OPEN_FILE,MainFrame::Open_File)
  ...
  //EVT_END_PROCESS(ID_PROCESS_END,Process_End)
  EVT_DATAVIEW_ITEM_ACTIVATED(wxID_ANY,MainFrame::FileSelect)
  EVT_DATAVIEW_ITEM_START_EDITING(wxID_ANY,MainFrame::FileNameEdit)
