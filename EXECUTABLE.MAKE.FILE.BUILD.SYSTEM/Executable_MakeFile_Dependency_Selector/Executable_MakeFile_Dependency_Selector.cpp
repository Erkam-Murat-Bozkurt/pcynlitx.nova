...
Executable_MakeFile_Dependency_Selector::Executable_MakeFile_Dependency_Selector(){
...
Executable_MakeFile_Dependency_Selector::Executable_MakeFile_Dependency_Selector(const

          Executable_MakeFile_Dependency_Selector & orig){
...
void Executable_MakeFile_Dependency_Selector::Clear_Dynamic_Memory(){
...
void Executable_MakeFile_Dependency_Selector::Receive_Executable_MakeFile_DataCollector(Executable_MakeFile_DataCollector * pointer){
...
void Executable_MakeFile_Dependency_Selector::Extract_Dependency_Data(char * path){
  ...
  bool Executable_MakeFile_Dependency_Selector::Is_This_Repo_HeaderFile(char * path){

       this->is_this_repo_header = false;

       bool is_header = this->Header_Determiner.Is_Header(path);

       int index_size = this->DataCollector->Get_Compiler_Data_Size();
  ...
  bool Executable_MakeFile_Dependency_Selector::Is_This_File_Aready_Searched(char * name){
  ...
  void Executable_MakeFile_Dependency_Selector::Determine_Header_Repo_Warehouse_Path(char ** wrd_path,
  ...
  void Executable_MakeFile_Dependency_Selector::Extract_Header_File_Name_From_Decleration(char ** header_name,
  ...
  void Executable_MakeFile_Dependency_Selector::Delete_Spaces_on_String(char ** pointer){
  ...
  void Executable_MakeFile_Dependency_Selector::Construct_Temporary_String(char ** tmp_string,
  ...
  bool Executable_MakeFile_Dependency_Selector::Include_Decleration_Test(char * string){
  ...
  bool Executable_MakeFile_Dependency_Selector::CompareString(char * firstString, char * secondString){
  ...
  size_t Executable_MakeFile_Dependency_Selector::CharListLength(char * Characterlist){
  ...
  void Executable_MakeFile_Dependency_Selector::Place_String(char ** str_pointer, char * string){
  ...
  void Executable_MakeFile_Dependency_Selector::Print_Dependency_List(){
  ...
  void Executable_MakeFile_Dependency_Selector::Clear_Pointer_Memory(char ** Pointer){
