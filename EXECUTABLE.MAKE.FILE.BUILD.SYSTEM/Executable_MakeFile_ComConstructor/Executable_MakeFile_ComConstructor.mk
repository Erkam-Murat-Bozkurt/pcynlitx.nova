...
VPATH = $(DIR_OPS) $(INT_TO_CHAR) $(CPP_OPS) $(CHAR_OPS) $(SOURCE_DETR) \
	    $(STRING_OPS) $(HEAD_DET) $(FILE_LISTER) \
	    $(DES_DATA_COL) $(DES_READER) \
...
Executable_MakeFile_ComConstructor.exe: Executable_MakeFile_ComConstructor_Main_File.cpp \
	...
	g++ -std=c++17 -g -o Executable_MakeFile_ComConstructor.exe \
	 	-I$(HEAD_DET) -I$(FILE_LISTER) \
	 	-I$(SOURCE_DETR) -I$(GIT_LIST) \
	    -I$(DES_READER) \
	    -I$(DES_DATA_COL) \
	 	-I$(FILE_DAT_COL) -I$(SRC_DT_COL) \
	 	-I$(DES_FILE_SYNT_COL) -I$(SRC_DEP_SL) \
	 	-I$(SRC_DER_RORD) -I$(SRC_COM_DT_EXT) \
		-I$(DIR_OPS) -I$(CPP_OPS) \
	 	-I$(CHAR_OPS) -I$(INT_TO_CHAR) \
	 	-I$(SRC_DEP_DTR) -I$(SRC_INF_COL) -I$(STRING_OPS) \
	 	-L$(SRC_INF_COL) \
	 	-L$(DIR_OPS) \
	 	-L$(CPP_OPS) \
	 	-L$(CHAR_OPS) \
