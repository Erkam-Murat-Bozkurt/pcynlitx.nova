...
VPATH = $(DIR_OPS)      $(INT_TO_CHAR) $(CPP_OPS)  \
		$(CHAR_OPS)     $(SOURCE_DETR) $(SYS_INT) \
	    $(STRING_OPS)   $(HEAD_DET)    $(SRC_DATA_SETTER) \
	    $(DES_DATA_COL) $(DES_READER)  $(QUICK_SRC_EXT)   \
		...
		$(GIT_REC)      $(GIT_MOD_LST) \
		$(GIT_MOD_RCV)  $(GIT_IGN) \
		$(DEP_DAT_EXT)  $(SRC_INF_CL_SF) $(SRC_READER) \
		$(SRC_DEP_SL_SF) \
		$(SRC_PROCESSOR) \
		$(HDR_PROC)
