...
VPATH = $(DIR_OPS) $(CPP_OPS) $(CHAR_OPS) $(CLASS_NAME) \
				$(CLASS_SYNTAX) $(DIR_ENUM) $(STRING_OPS) $(HEAD_DET)

Make_File_Builder.exe: Make_File_Builder_Main_File.cpp Make_File_Builder.cpp \
	Directory_Enumerator.cpp Header_File_Determiner.cpp ClassNameReader.cpp \
	ClassSyntaxControl.cpp DirectoryOperations.cpp \
	CharOperator.cpp Cpp_FileOperations.cpp Make_File_Builder.h Directory_Enumerator.h  \
	Header_File_Determiner.h DirectoryOperations.h CharOperator.h Cpp_FileOperations.h
	...
	g++ -std=c++17 -o Make_File_Builder.exe -I$(DIR_OPS) -I$(CPP_OPS) -I$(CHAR_OPS) \
	 ...
	 -L$(CLASS_NAME) -L$(CLASS_SYNTAX) -L$(STRING_OPS) -L$(HEAD_DET) \
		...
		-include $(HEAD_DET)\Header_File_Determiner.h -include $(CLASS_NAME)\ClassNameReader.h \
