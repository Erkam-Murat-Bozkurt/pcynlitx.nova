...
Compiler_Script_Writer.exe: Compiler_Script_Writer_Main_File.cpp Compiler_Script_Writer.cpp \
	Project_Directory_Lister.cpp Repo_Dir_Determiner.cpp Directory_Enumerator.cpp Directory_Enumerator.cpp \
	Directory_Tree_Size_Determiner.cpp ClassNameReader.cpp ClassSyntaxControl.cpp StringOperator.cpp \
  Cpp_FileOperations.cpp CharOperator.cpp Project_Directory_Lister.h  \
	...
	g++ -std=c++17 -o Compiler_Script_Writer.exe -I$(DIR_LIST) -I$(DIR_ENUM) -I$(REPO_DET) \
	 -I$(DIR_TREE) -I$(DIR_OPS) -I$(STRING_OPS) -I$(CHAR_OPS) -I$(FILE_OPRS) -I$(NAME_READER) \
	 -I$(SYNTAX_READER) -L$(DIR_LIST) -L$(DIR_ENUM) -L$(REPO_DET) -L$(DIR_TREE) -L$(DIR_OPS) \
	 -L$(STRING_OPS) -L$(CHAR_OPS) -L$(FILE_OPRS) -L$(NAME_READER) -L$(SYNTAX_READER) \
		Compiler_Script_Writer_Main_File.cpp Compiler_Script_Writer.cpp \
		$(DIR_LIST)\Project_Directory_Lister.cpp $(REPO_DET)\Repo_Dir_Determiner.cpp \
		...
		-include Compiler_Script_Writer.h -include $(DIR_LIST)\Project_Directory_Lister.h \
