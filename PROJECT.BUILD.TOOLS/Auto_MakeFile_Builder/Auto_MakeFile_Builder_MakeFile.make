...
$(STRING_OPS) $(CHAR_OPS) $(FILE_OPRS) $(MAKE_BLD) $(CLASS_NAME) $(CLASS_SYNTAX)

Auto_MakeFile_Builder.exe: Auto_MakeFile_Builder_Main_File.cpp Auto_MakeFile_Builder.cpp \
	Project_Directory_Lister.cpp Directory_Enumerator.cpp Repo_Dir_Determiner.cpp \
	...
	g++ -std=c++17 -o Auto_MakeFile_Builder.exe -I$(DIR_LIST) -I$(MAKE_BLD) -I$(DIR_ENUM) \
	 -I$(REPO_DET) -I$(DIR_TREE) -I$(DIR_OPS) -I$(STRING_OPS) \
   -I$(CHAR_OPS) -I$(FILE_OPRS) -I$(CLASS_NAME) -I$(CLASS_SYNTAX) \
	 -L$(DIR_LIST) -L$(MAKE_BLD) -L$(DIR_ENUM) -L$(REPO_DET) -L$(DIR_TREE) -L$(DIR_OPS) \
	 -L$(STRING_OPS) -L$(CHAR_OPS) -L$(FILE_OPRS) -L$(CLASS_NAME) -L$(CLASS_SYNTAX) \
		Auto_MakeFile_Builder_Main_File.cpp Auto_MakeFile_Builder.cpp $(DIR_LIST)\Project_Directory_Lister.cpp \
		$(MAKE_BLD)\Make_File_Builder.cpp $(DIR_ENUM)\Directory_Enumerator.cpp $(REPO_DET)\Repo_Dir_Determiner.cpp \
		...
		-include Auto_MakeFile_Builder.h -include $(DIR_LIST)\Project_Directory_Lister.h \
