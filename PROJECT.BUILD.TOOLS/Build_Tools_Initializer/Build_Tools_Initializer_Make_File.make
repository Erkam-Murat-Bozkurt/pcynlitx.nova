...
VPATH = $(DIR_LIST) $(DIR_ENUM) $(DIR_TREE) $(DIR_OPS) $(STRING_OPS) $(CHAR_OPS) $(FILE_OPRS) \
				$(SCR_WRIT) $(REPO_INI) $(AUTO_MAK) $(MAKE_BLD) $(CLASS_NM) $(CLASS_SY)
...
Build_Tools_Initializer.exe: Build_Tools_Initializer_Main_File.cpp Build_Tools_Initializer.cpp \
	...
	Directory_Tree_Size_Determiner.cpp Make_File_Builder.cpp StringOperator.cpp \
	ClassNameReader.cpp ClassSyntaxControl.cpp \
	Cpp_FileOperations.cpp CharOperator.cpp Build_Tools_Initializer.h Auto_MakeFile_Builder.h \
	Compiler_Script_Writer.h Repo_Warehouse_Initializer.h \
	Project_Directory_Lister.h Directory_Enumerator.h Make_File_Builder.h \
	ClassNameReader.h ClassSyntaxControl.h \
	...
	g++ -std=c++17 -o Build_Tools_Initializer.exe -I$(DIR_LIST) -I$(DIR_ENUM) \
	 ...
	 -L$(SCR_WRIT) -L$(REPO_INI) -L$(AUTO_MAK) -L$(CLASS_NM) -L$(CLASS_SY) \
		...
		$(REPO_INI)\Repo_Warehouse_Initializer.cpp $(DIR_LIST)\Project_Directory_Lister.cpp \
		$(DIR_ENUM)\Directory_Enumerator.cpp $(DIR_TREE)\Directory_Tree_Size_Determiner.cpp  \
		$(CLASS_NM)\ClassNameReader.cpp $(CLASS_SY)\ClassSyntaxControl.cpp \
		$(DIR_OPS)\DirectoryOperations.cpp $(MAKE_BLD)\Make_File_Builder.cpp $(STRING_OPS)\StringOperator.cpp \
		...
		-include $(REPO_INI)\Repo_Warehouse_Initializer.h -include $(DIR_LIST)\Project_Directory_Lister.h \
		...
		-include $(CLASS_NM)\ClassNameReader.h -include $(CLASS_SY)\ClassSyntaxControl.h \
