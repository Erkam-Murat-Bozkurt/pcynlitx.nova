...
PRO_FILE_DAT_COL=D:\pcynlitx.build\PROJECT.BUILD.TOOLS\Project_Files_Data_Collector
...
VPATH = $(DIR_LIST) $(DIR_ENUM) $(DIR_TREE) $(DIR_OPS) \
				...
				$(SCR_WRIT) $(REPO_INI) $(AUTO_MAK) $(MAKE_BLD) $(CLASS_NM) \
...
Build_Tools_Initializer.exe: Build_Tools_Initializer_Main_File.cpp Build_Tools_Initializer.cpp \
	...
	Make_File_Builder.cpp MakeFile_Data_Collector.cpp StringOperator.cpp \
	...
	Directory_Enumerator.h Make_File_Builder.h Project_Files_Data_Collector.hpp \
	MakeFile_Data_Collector.hpp StringOperator.h DirectoryOperations.h \
	...
	g++ -std=c++17 -o Build_Tools_Initializer.exe -I$(DIR_LIST) -I$(DIR_ENUM) \
	 ...
	 -I$(MAKE_DAT) -I$(GIT_REC) -I$(SRC_DAT_COL) -I$(PRO_FILE_DAT_COL) -I$(TRANSLATER) \
	 -L$(DIR_LIST) -L$(DIR_ENUM) -L$(REPO_DET) -L$(DIR_TREE) -L$(DIR_OPS) \
	 -L$(STRING_OPS) -L$(CHAR_OPS) -L$(FILE_OPRS) -L$(MAKE_BLD) -L$(MAKE_DAT) \
	 -L$(SCR_WRIT) -L$(REPO_INI) -L$(AUTO_MAK) -L$(CLASS_NM) -L$(CLASS_SY) \
	 -L$(DES_READ) -L$(DES_DAT_COL) -L$(HEAD_FILE_DET) -L$(SOURCE_FILE_DET) \
	 -L$(GIT_REC) -L$(SRC_DAT_COL) -L$(PRO_FILE_DAT_COL) -L$(TRANSLATER) \
		...
		$(SRC_DAT_COL)\Source_File_Data_Collector.cpp $(GIT_REC)\Git_File_List_Receiver.cpp \
		...
		$(MAKE_DAT)\MakeFile_Data_Collector.cpp $(PRO_FILE_DAT_COL)\Project_Files_Data_Collector.cpp \
		$(STRING_OPS)\StringOperator.cpp $(TRANSLATER)\IntToCharTranslater.cpp \
