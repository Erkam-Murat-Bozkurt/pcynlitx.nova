...
Project_Files_Lister.exe: Project_Files_Lister_Main_File.cpp Project_Files_Lister.cpp  \
	...
	g++ -std=c++17 -o Project_Files_Lister.exe \
	 -I$(HEAD_DETR) -I$(SOURCE_DETR) -I$(DIR_OPS) -I$(STRING_OPS) \
	 ...
	 -L$(DES_READ) -L$(DES_DATA_COL) -L$(SRC_DT_COL) \
		...
		$(DES_DATA_COL)\Descriptor_File_Data_Collector.cpp $(GIT_LIST)\Git_File_List_Receiver.cpp \
		$(SRC_DT_COL)\Source_File_Data_Collector.cpp $(DIR_OPS)\DirectoryOperations.cpp \
		$(STRING_OPS)\StringOperator.cpp $(FILE_DAT_COL)\Project_Files_Data_Collector.cpp \
		...
		-include $(DES_READ)\Descriptor_File_Reader.hpp $(SRC_DT_COL)\Source_File_Data_Collector.hpp \
		-include $(DES_DATA_COL)\Descriptor_File_Data_Collector.hpp $(GIT_LIST)\Git_File_List_Receiver.hpp \
